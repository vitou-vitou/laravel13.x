...
| Item | Status |
|------|--------|
| Spec-Kit | `001-my_app_22` — **not started** (scaffold only) |
...
cd /d/laravel13.x/examples/my-app-22
composer install
php artisan test
npm run dev
```
...
1. Edit `.specify/specs/001-my_app_22/spec.md` (what/why)
2. `plan.md` → `tasks.md`
