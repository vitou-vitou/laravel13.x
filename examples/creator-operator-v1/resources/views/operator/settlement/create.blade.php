<x-app-layout>
    <x-slot name="header">
        <div>
            <h2 class="ops-page-title">Add monthly settlement</h2>
            <p class="ops-page-subtitle">{{ '@'.$creator->handle }} · S÷T formula</p>
        </div>
    </x-slot>
    ...
    <div class="ops-page">
        <div class="ops-container-form ops-stack">
            ...
            <div class="ops-flash-info">
                ...
                <span class="text-indigo-700/90">(S÷T attribution from README)</span>
            </div>

            <x-ops-panel>
                <form method="POST" action="{{ route('operator.creators.settlement.store', $creator) }}" class="space-y-4">
                    @csrf
                    ...
                    <div class="grid sm:grid-cols-2 gap-4">
                        <div>
                            ...
                            <select id="platform" name="platform" class="mt-1 ops-select" required>
                        ...
                        <div>
                            ...
                            <select id="payout_status" name="payout_status" class="mt-1 ops-select" required>
                    ...
                    <div>
                        ...
                        <textarea id="notes" name="notes" rows="2" class="mt-1 ops-input">{{ old('notes') }}</textarea>
                    </div>
            ...
            <p class="ops-panel-footer border-0 bg-transparent px-0 py-0 text-stone-500">
                Creator sees the same attributed and net numbers on their read-only settlement statement. 14-day dispute window per spec.
            </p>
        </div>
    </div>
</x-app-layout>
