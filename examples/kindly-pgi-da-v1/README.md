# Multi-vendor Marketplace (kindly-pgi-da-v1)
...
**URL:** http://kindly-pgi-da-v1.test (Herd)

## Quick start

```bash
export PATH="/d/laravel13.x/bin:$PATH"
cd examples/kindly-pgi-da-v1
composer install
php artisan migrate:fresh --seed
php artisan test
```

From repo root: `./bin/verify-example kindly-pgi-da-v1`
