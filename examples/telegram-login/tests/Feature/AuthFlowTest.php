...
class AuthFlowTest extends TestCase
{
    ...
    public function test_auth_start_redirects_to_telegram_oauth_for_widget_flow(): void
    {
        $tenant = Tenant::query()->create(['name' => 'Acme', 'slug' => 'acme', 'plan' => 'free']);
        ...
        $response->assertOk();
        $response->assertSee('Completing Telegram login', false);
        $response->assertSee('oauth.telegram.org/auth', false);
        $response->assertSee('parseTgAuthResult', false);
        $response->assertDontSee('embed=1', false);
    }
