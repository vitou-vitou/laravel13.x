...
use App\Http\Controllers\DemoShopController;
...
Route::prefix('demo-shop')->name('demo-shop.')->group(function (): void {
    Route::get('/', [DemoShopController::class, 'index'])->name('index');
    Route::get('/login', [DemoShopController::class, 'login'])->name('login');
    Route::get('/callback', [DemoShopController::class, 'callback'])->name('callback');
    Route::post('/logout', [DemoShopController::class, 'logout'])->name('logout');
});
...
Route::middleware('auth')->prefix('dashboard')->group(function (): void {
    ...
    Route::post('/onboarding/test-link', [OnboardingController::class, 'generateTestLink'])->name('dashboard.onboarding.test-link');
    Route::post('/onboarding/enable-demo', [OnboardingController::class, 'enableDemoShop'])->name('dashboard.onboarding.enable-demo');
});
