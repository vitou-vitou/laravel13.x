...
class CustomerTaskResource extends Resource
{
    protected static ?string $model = CustomerTask::class;

    protected static string|BackedEnum|null $navigationIcon = Heroicon::OutlinedUserGroup;
    protected static string|UnitEnum|null $navigationGroup = 'Operations';
    protected static ?string $navigationLabel = 'Customer Tasks';
    ...
    public static function table(Table $table): Table
    {
        return $table
            ->columns([
                ...
                Tables\Columns\TextColumn::make('handler.name')->label('Handler'),
    ...
    public static function getPages(): array
    {
        return [
            ...
            'create' => Pages\CreateCustomerTask::route('/create'),
            'edit' => Pages\EditCustomerTask::route('/{record}/edit'),
        ];
    }
}
