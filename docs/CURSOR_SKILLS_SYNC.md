...
| `tbench-prompt-library/` | Distilled trial packs, harness, quality/speed judge, catalog router | tbench self-improvement, waffle task slug, grok prompt structure, fix issue harness |
